...
[Graph API](/oss/python/langgraph/graph-api) 使用声明式方法，您可以在其中定义节点、边和共享状态以创建可视化图结构。
...
[Functional API](/oss/python/langgraph/functional-api) 使用命令式方法，将 LangGraph 功能集成到标准过程代码中。
